...
{
	//https://github.com/Gasparfx/SoundManager/blob/master/README.md
	...
	#region Singleton
	private static SoundManager1 _instance;
	...
	public static SoundManager1 Instance
	{
		get
		{
			...
			{
				Debug.LogWarning("[Singleton] Instance '" + typeof(SoundManager1) +
			...
			return new GameObject("SoundManager (singleton)").AddComponent<SoundManager1>();
		}
	}
